...
export default function LoginScreen(props) {
  ...
  function ScreenModal() {
    ...
    switch (mode) {
      case 'login':
        return (
          <div id="loginmodal">
            ...
            <br />
            <a>
              <button id="dolog" className="loginsystem" onClick={login}>
                Login
              </button>
            </a>
            <button id="backuplogin" className="loginsystem" onClick={back}>
              Back
            </button>
            <br />
            <br />
            ...
            <br />
            <a className="loginsystem" style={{ cursor: 'pointer' }} onClick={forgot}>
              Forgot Password?
            </a>
            <br />
          </div>
      ...
      case 'start':
        return (
          <div id="ipblogin" className="loginsystem">
            <br />
            <button id="openlogin" className="loginsystem" onClick={openLogin}>
              Login
            </button>
            <button id="doregister" className="loginsystem" onClick={registration}>
              Register
            </button>
          </div>
        );
      case 'register':
        return (
          <div id="loginmodal">
            ...
            <br />
            <br />
            <button id="openlogin" className="loginsystem" onClick={registerAccount}>
              Register
            </button>
            <button id="backuplogin" className="loginsystem" onClick={back}>
              Back
      ...
      case 'remember':
        return (
          <div id="loginmodal">
            ...
            />
            <br />
            <button id="dolog" className="loginsystem" onClick={recoverAccount}>
              Remember
            </button>
            <button id="backuplogin" className="loginsystem" onClick={openLogin}>
              Back
            </button>
            <br />
            <br />
            <a className="loginsystem" onClick={useRecoverCode}>
              Use Recovery Code
            </a>
          </div>
        );
      ...
      case 'loggedin':
        return (
          <div id="loginmodal">
            <br />
            <button id="backuplogin" className="loginsystem" onClick={logout}>
              Logout
            </button>
          </div>
        );
