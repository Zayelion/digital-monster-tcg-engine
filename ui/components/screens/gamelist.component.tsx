        ...
        <div>
          <div key="col-1" className="filtercol">
            <select key="banlist" id="banlist" onChange={onChange}>
              {[
                <option key="empty" value="" selected={true}>
                  Banlist
                </option>
              ].concat(
                banlist.map((list, i) => {
            ...
            <select key="automatic" id="automatic" onChange={onChange}>
              ...
              <option key="a" value="Automatic">
                Automatic
              </option>
              <option key="m" value="Manual">
                Manual
              </option>
            </select>
            <div key="ranked" id="ranked" onChange={onChange}>
              ...
              <option key="r" value="Ranked">
                Ranked
              </option>
              <option key="e" value="Exhibition">
                Exhibition
              </option>
            </div>
